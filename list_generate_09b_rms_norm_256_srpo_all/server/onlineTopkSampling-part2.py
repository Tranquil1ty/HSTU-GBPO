...
service_name = "grpc_list09b_predict-part2"
    ...
    def retrieve(self, **kwargs):
        ...
        return (
            ...
            .if_("request_type == 'end2end' or request_type == 'eval_request'")
                ...
                .fake_retrieve(item_keys=[i for i in range(129, 129+128)])
...
service.IGNORE_UNUSED_ATTR = [
    ...
    "return_m_input_out", "top_k_sampling_k_input_out", "session_photo_id_list", "check_return_m", "fake_item_num"
]
