...
def build_cross_former_self_layers(q, kv, cross_ffn_dim, self_ffn_dim, hidden_dim, 
    ...
    bos_token_emb = tf.get_variable(f"{name}_bos_token_emb", (1, 1, hidden_dim))
    bos_token_emb = tf.tile(bos_token_emb, [batch_size, 1, 1])
    q = tf.concat([bos_token_emb, q], axis=1)
