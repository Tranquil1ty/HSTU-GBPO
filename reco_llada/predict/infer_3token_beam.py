...
TAB_NEBULA = 30000
kess_name = "grpc_ar_3token_beam64"

model_config = dict(
    model_config=load_model("./3token_beam64"),
    colossusdb_embd_service_name="reco_llada",
    colossusdb_embd_table_name="reco_ar_3token_emb",
    embedding_shard_num=8,
    queue_prefix="reco_ar_3token",
...
class PredictServerFlow(LeafFlow, CommonApiMixin, KuibaApiMixin, MioApiMixin, UniPredictApiMixin, EmbeddingApiMixin):
    ...
    def prepare_fake_item(self):
        ...
        self.fake_retrieve(num=1, reason=777)
    ...
    def item_rag(self):
        ...
        self.delegate_enrich(
            ...
            request_type="test_infer_request",
        )
        self.log_debug_info( 
            common_attrs = ["user_seq_slots"], 
            item_attrs = ["item_rag_slots"], 
            for_debug_request_only=True, 
            respect_sample_logging=False
        )
    ...
    def infer(self):
        ...
        #                         tensor_name="semantic_id_v2", common=False, dim=3))
    ...
    def infer_step(self):
        ...
        self.truncate(size_limit=0)
        self.fake_retrieve(num="{{beam_size}}")
        self.dispatch_common_attr(
            dispatch_config = [
                {
    ...
    def main(self):
        ...
        self.enrich_attr_by_lua(
            ...
            export_common_attr=["infer_steps", "token_num", "vocab_size"],
            function_for_common="calculate",
            lua_script="""
                function calculate()
                    local infer_steps = {}
