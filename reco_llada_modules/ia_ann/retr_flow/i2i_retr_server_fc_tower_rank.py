...
kconf_key = "reco.start_auto_param.i2i_retr_server_config_fc_tower_rank"
kconf_config = {
    # 默认的kconf配置值
    # colossus trigger
    ...
    # post rank 排序
    "enable_post_rank": 1,
    "enable_post_rank_local_cache": 1,
    "post_rank__input_num": 3000,
    "post_rank__pxtr_timeout_ms": 20,
    "post_rank__pxtr_label": ["ctr", "lvr", "lad_lvr", "vtr"],
    "post_rank__pxtr_weight": [1.0, 1.0, 0.0, 0.0],
    "post_rank__min_pxtr": 0.0,
    "post_rank__result_num": 1600,
...
ab_config_map = {
    ...
    "ab_params": [
       ("ia_retr_kconf_key_nebula", "reco.start_auto_param.i2i_retr_server_config_fc_tower_rank"),
       ("ia_retr_kconf_key_gamora", "reco.start_auto_param.i2i_retr_server_config_fc_tower_rank"),
    ]
}
...
class I2IRetrFlow(
    ...
    def _user_infer(self):
        from fc_tower_full_link_infer_flow import fc_tower_full_link_infer_flow
        self.enrich_by_sub_flow(
            sub_flow=fc_tower_full_link_infer_flow,
            deepcopy=False,
            merge_common_attrs=[
                "user_top_layer",
            ]
    ...
    def post_rank(self):
        tower_labels = ["ctr", "lvr", "lad_lvr", "vtr"]
        return (
            self
            ...
            .if_("user_top_layer ~= nil and candiate_item_num > post_rank__result_num")
                ...
                # refer: https://git.corp.kuaishou.com/reco/new_arch_tower/-/blob/2a4771a8bc29057006b4b5d7c1ca7f9f5d565cf0/dragonfly/api/flow_infer.py#L86
                .fetch_tower_remote_pxtr( # 向远端请求预估多个label (or target) 的多个 user * item 的pxtr
                    ...
                    output_type=2,
                    pxtr_kess_service="grpc_cascade_retrieval_distillPxtr",
                    pxtr_shards=2,
                    pxtr_subreq_num_in_shard=3,
...
service = LeafService(
    kess_name="grpc_slideI2ICenterServer-i2i-ia-retr-server-rank",
